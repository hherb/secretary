...
from payload_guard.config import (
    ...
    GATED_FIELD_NAMES, REPO_ROOT, SCAN_ROOT,
)
...
from payload_guard.discovery import (
    ERROR_ATTR_RE, STRUCT_RE, _discover_tier_inputs, _inside, _owning_enum_name,
    discover_declarations, discover_error_struct_declarations,
    discover_scanned_error_type_names, discovery_cfg_test_spans, enclosing_enum_names,
    foreign_use_names, resolve_consts, skip_attributes, split_top_level,
)
