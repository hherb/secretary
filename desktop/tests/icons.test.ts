...
import Pencil from '../src/components/icons/Pencil.svelte';
import Move from '../src/components/icons/Move.svelte';
...
describe('icons — render contract', () => {
  ...
  it('every icon renders a non-empty SVG', () => {
    for (const Icon of [Eye, EyeOff, Link, Trash, Users, Settings, Sync, Pencil, Move]) {
