...
## Sub-project B — FFI bindings 🚧 (B.1 Python complete; B.1.1 Swift complete; B.1.1.1 Kotlin complete; B.2 password unlock complete; B.3a recovery unlock complete; B.3b create_vault complete)
...
- **B.4** — Block save / share / open exposed.
