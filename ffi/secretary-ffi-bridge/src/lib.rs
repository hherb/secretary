...
pub use create::{
    create_vault, create_vault_in_folder, CreateVaultOutput, CreatedVaultInFolder, MnemonicOutput,
};
pub use device::{
...
pub use sync::{
    ...
    sync_vault_in, CollisionDto, DeviceClockDto, SyncOutcomeDto, SyncStatusDto, VetoDecisionDto,
    VetoDto,
};
